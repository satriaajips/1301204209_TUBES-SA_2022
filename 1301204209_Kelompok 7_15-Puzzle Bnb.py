...
# SOLVEABLE FUZZLE
#matrix = np.array([1, 2, 3, 4, 5, 6, 7, 8, 0, 10, 11, 12, 9, 13, 14, 15]).reshape(4,4)
#matrix = np.array([1, 2, 3, 4, 5, 6, 0, 8, 9, 10, 7, 11, 13, 14, 15, 12]).reshape(4,4)
matrix = np.array([1, 6, 2, 3, 5, 7, 4, 0, 9, 10, 11, 8, 13, 14, 15, 12]).reshape(4,4)

print("Cost = "+str(cost(0,matrix,final)))
print_kurang(matrix)
